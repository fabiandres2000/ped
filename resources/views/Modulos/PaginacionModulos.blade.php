        ...
        <div class="col-md-10">
            <ul class="pagination">
                ...
                @if ($actual != 1)
                    <li class="page-item ">
                        <a class="page-link"
                            href="{{ url('/Modulos/GestionModulos/?page=' . ($actual - 1) . '&txtbusqueda=' . $busqueda) }}"
                            aria-label="Previous">
                ...
                @if ($primera != 1)
                    <li class="page-item ">
                        <a class="page-link"
                            href="{{ url('/Modulos/GestionModulos/?page=1&txtbusqueda=' . $busqueda) }}"
                            aria-label="Previous">
                ...
                @for ($i = $primera; $i <= $ultima; $i++)
                    ...
                    @else
                        <li class="page-item">
                            <a class="page-link"
                                href="{{ url('/Modulos/GestionModulos/?page=' . $i . '&txtbusqueda=' . $busqueda) }}"
                                aria-label="Previous">
                ...
                @if ($ultima != $paginas)
                    ...
                    <li class="page-item ">
                        <a class="page-link"
                            href="{{ url('/Modulos/GestionModulos/?page=' . $paginas . '&txtbusqueda=' . $busqueda) }}"
                            aria-label="Previous">
                ...
                @if ($actual != $paginas)
                    <li class="page-item {{ $actual == $paginas ? ' disabled' : '' }}">
                        <a class="page-link"
                            href="{{ url('/Modulos/GestionModulos/?page=' . ($paginas + 1) . '&txtbusqueda=' . $busqueda) }}">»</a>
                    </li>
                @endif
            </ul>
        </div>
