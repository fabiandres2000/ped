...
@section('title', 'Editar Evaluación / Actividad')
@section('Contenido')

    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <h3 class="content-header-title mb-0">GESTIÓN DE EVALUACIONES Y ACTIVIADES</h3>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <!--begin::Form-->
                                @include('Modulos.FormAsigEvaluacion', [
                                    'url' => '/Modulos/guardarEvaluacion/',
                                    'method' => 'post',
                                ])
                                <!--end::Form-->
                                <p class="px-1"></p>
    ...
    {!! Form::open(['url' => '/Asignaturas/CargarEvaluacion', 'id' => 'formAuxiliarEvalDet']) !!}
    {!! Form::close() !!}

    {!! Form::open(['url' => '/Asignaturas/consulEvalPreg', 'id' => 'formAuxiliarEval']) !!}
    {!! Form::close() !!}

    {!! Form::open(['url' => '/Asignaturas/ElimnarPreg', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}
        ...
        $(document).ready(function() {
            ...
            $.extend({
                ...
                GuardarEval: function(id) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: rurl + "Asignaturas/GuardarEvalFin",
                        data: new FormData($('#formAsigEval')[0]),
                        processData: false,
                        contentType: false,
                        success: function(respuesta) {
