...
@section('title', 'Asignar Evaluación a Temas')
@section('Contenido')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Crear Evaluación / Actividad
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" style="padding-bottom:0px;">
                            <h4>Crear Evaluación / Actividad</h4>
                        </div>
