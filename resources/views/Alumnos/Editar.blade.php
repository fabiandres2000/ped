...
@section('Contenido')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Gestión de Alumnos</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/Administracion') }}">Inicio</a>
                        </li>
                        <li class="breadcrumb-item active">Editar Alumno
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                @include('Alumnos.Form', [
                                    'url' => '/Alumnos/modificar/' . $Alumno->id,
                                    'method' => 'put',
                                ])
                                <!--end::Form-->
                                <p class="px-1"></p>
        ...
        $(document).ready(function() {
            ...
            $.extend({
                VerFotEst: function() {
                    ...
                    jQuery('#embed_arch').attr('src', $('#dat').data("ruta") + "/" + $('#fotoalumno')
                        .val());
                },
                CambFotEst: function() {
                    $("#id_verf").hide();
                ...
                ValidIdent: function(ident) {
                    ...
                    $("#idAlum").remove();
                    form.append("<input type='hidden' name='id' id='idAlum' value='" + ident + "'>");
