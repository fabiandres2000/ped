            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    <div class="media" style="padding: 0.2rem;">
                        ...
                        <div class="media-body" style="padding-top: 0.6rem; color: #fff">
                          <h4 class="media-heading" style="margin-bottom: 0px;">{{ Session::get('NombreColegio') }}</h4>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ url('/cambiarclave') }}"><i
                                    class="ft-check-square"></i> Cambiar Clave</a>
