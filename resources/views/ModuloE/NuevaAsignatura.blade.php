                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                @include('ModuloE.FormAsignatura', [
                                    'url' => '/ModuloE/GuardarAsignaturas',
                                    'method' => 'post',
                                ])
                                <!--end::Form-->
                                <p class="px-1"></p>
            ...
            $("#AddCompe").on({
                click: function(e) {
                    ...
                    $('#tr_compe input').each(function() {
                        if ($(this).val() === IdComp) {
                            Swal.fire('Error!', 'Esta Competencia ya esta Agregada...',
                                'warning');
                            flag = "no";
                        }
                    });
                    ...
                    var campo = "";
                    campo += "<tr id='tr_Compe_" + ConsComp + "'>";
            ...
            $("#AddCompo").on({
                click: function(e) {
                    ...
                    $('#tr_compo input').each(function() {
                        if ($(this).val() === IdCompo) {
                            Swal.fire('Error!', 'Este Componente ya esta Agregado...',
                                'warning');
                            flag = "no";
                        }
                    });
                    ...
                    var clase = 'text-truncate';
                    var campo = "";
                    campo += "<tr id='tr_Compo_" + ConsCompo + "'>";
                    campo += "<td class='" + clase + "'>";
                    campo += TxtCom;
                    campo += "</td>";
                    campo += "<td class='" + clase + "'>";
