...
@section('title', 'Editar Componentes')
@section('Contenido')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Editar Componentes
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Editar Componentes.</h4>
                        </div>
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <!--begin::Form-->
                                @include('ModuloE.FormComponente', [
                                    'url' => '/ModuloE/ModificarComponente/' . $Comp->id,
                                    'method' => 'put',
                                ])
                                <!--end::Form-->
                                <p class="px-1"></p>
