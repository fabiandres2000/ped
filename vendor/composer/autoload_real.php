...
class ComposerAutoloaderInit14ac199b7c5ff7e308bed912bd330e2a
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit14ac199b7c5ff7e308bed912bd330e2a::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire14ac199b7c5ff7e308bed912bd330e2a($fileIdentifier, $file);
        }
...
function composerRequire14ac199b7c5ff7e308bed912bd330e2a($fileIdentifier, $file)
{
